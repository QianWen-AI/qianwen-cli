...
export const mockModels = [
  // 1. qwen3.6-plus — Multimodal LLM (Text+Img+Video→Text), tiered pricing with cache, built-in tools, context 1M
  {
    id: 'qwen3.6-plus',
    description:
      'Qwen3.6 native vision-language flagship, outperforming the 3.5 series across reasoning, code, and multimodal understanding.',
    ...
    pricing: {
      ...
      built_in_tools: [
        ...
        { name: 'i2i_search', price: 8.0, unit: 'USD/1K calls', api: 'Responses API' },
        { name: 't2i_search', price: 8.0, unit: 'USD/1K calls', api: 'Responses API' },
      ],
    },
  ...
  // 2. qwen-plus — Text LLM (Text→Text), single-tier pricing, context ~128K
  {
    id: 'qwen-plus',
    description:
      'Qwen Plus model, suitable for general text tasks with an excellent balance of performance and cost.',
    tags: ['Text Generation', 'General Purpose'],
    modality: { input: ['text'], output: ['text'] },
    features: ['Prefix Completion', 'Function Calling', 'Structured Outputs', 'Batches'],
    pricing: {
      tiers: [{ label: 'All contexts', input: 0.14, output: 0.56, unit: 'USD/1M tokens' }],
    },
  ...
  // 3. qwen-vl-max — Vision LLM (Text+Img+Video→Text), tiered pricing
  {
    id: 'qwen-vl-max',
    description:
      'Qwen VL Max vision-language flagship model, supporting in-depth understanding and multi-turn dialogue over images and videos.',
  ...
  // 4. qwen3-asr-flash — ASR (Audio→Text), per-second pricing
  {
    id: 'qwen3-asr-flash',
    description:
      'Qwen3 ASR Flash speech recognition model, high-speed and low-latency, suitable for real-time transcription scenarios.',
  ...
  // 5. wan2.6-t2i — Image generation (Text→Image), per-image pricing
  {
    id: 'wan2.6-t2i',
    description:
      'Wan2.6 text-to-image model, supporting high-quality image generation across a variety of styles and resolutions.',
  ...
  // 6. wan2.7-r2v — Video generation (Img+Video→Video), per-second by resolution pricing
  {
    id: 'wan2.7-r2v',
    description:
      'Wan2.7 image-to-video model, supporting high-quality video generation driven by reference images.',
    tags: ['Video Generation', 'Image to Video'],
    modality: { input: ['audio', 'image', 'text', 'video'], output: ['video'] },
    features: [],
    pricing: {
      per_second: [
        { resolution: '720P', price: 0.1, unit: 'USD/second' },
    ...
    free_tier: {
      mode: 'standard',
      quota: { remaining: 25, total: 25, unit: 'seconds', used_pct: 0 },
    },
  ...
  // 7. cosyvoice-v3-plus — TTS (Text→Audio), per-character pricing
  {
    ...
    description:
      'CosyVoice speech synthesis model, supporting multilingual, multi-voice, and emotionally rich speech output.',
    ...
    free_tier: {
      mode: 'standard',
      quota: { remaining: 7200, total: 10000, unit: 'characters', used_pct: 28 },
    },
  ...
  // 8. qwen3.5-omni-plus — Omni model (Text+Img+Video+Audio→Text+Audio), free only
  {
    ...
    description:
      'Qwen3.5 Omni Plus omnimodal model, supporting text, image, video, and audio inputs with text and audio outputs. Free during Early Access.',
    tags: ['Omni', 'Multimodal', 'Early Access'],
    modality: { input: ['text', 'image', 'video', 'audio'], output: ['text', 'audio'] },
    features: ['Function Calling'],
    pricing: {
      tiers: [{ label: 'FreeTier Only', input: 0, output: 0, unit: 'free' }],
    },
    context: { context_window: 131072, max_input: 129024, max_output: 16384 },
